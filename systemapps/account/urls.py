...
accounts_urlpatterns = [
    ...
    re_path(r'^profile/$', login_required(account_views.ProfileView.as_view()), name='profile'),
    re_path(r'^profile/(?P<activetab>[0-9]{1})/$',
            login_required(account_views.ProfileView.as_view(), login_url='login'), name='profile'),
